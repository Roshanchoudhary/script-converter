...
// आधा य् (्य) पर नुक्ता नहीं लगेगा
// ============================================================
...
(function() {
  ...
  function applyYaRule(text) {
    ...
    for (const word of words) {
      ...
      for (let i = 0; i < len; i++) {
        ...
        if (char === 'य') {
          // ============================================================
          // RULE 1: आधा य् (्य) - नुक्ता नहीं लगेगा ❌
          // चेक करें: पहले या बाद में कोई consonant है?
          // ============================================================
          const isHalfYa = (prevChar && CONSONANTS.has(prevChar)) || 
                           (nextChar && CONSONANTS.has(nextChar));
          
          // ============================================================
          // RULE 2: शब्द के अंत में पूरा य → य़ ✅
          // ============================================================
          if (i === len - 1 && !isHalfYa) {
            converted += 'य़';
          }
          // ============================================================
          // RULE 3: शब्द के बीच में पूरा य → य़ ✅
          // (जब आधा य् न हो)
          // ============================================================
          else if (i > 0 && i < len - 1 && !isHalfYa) {
            // Check if it's part of a conjunct where य is half
            ...
            if (isConjunct || isHalfYa) {
              converted += 'य'; // आधा य् - नुक्ता नहीं
            } else {
              converted += 'य़'; // पूरा य - नुक्ता लगेगा
            }
          }
          // ============================================================
  ...
  // ============================================================
  // CONSONANTS SET for checking आधा य्
  // ============================================================
  ...
  function runTests() {
    ...
    console.log('📝 आधा य् (्य) पर नुक्ता नहीं लगेगा\n');
  ...
  function init() {
    ...
    console.log('📝 य → य़ नियम: आधा य् (्य) पर नुक्ता नहीं लगेगा');
